...
contract TheOpepenArchive is Ownable {
    ...
    /// @param metadataURI The metadata URI to set
    function setCustomMetadataURI(uint256 key, string memory metadataURI) public onlyOwner {
    ...
    function linkTokensToSubEditionMetadataKeys(uint256[] memory tokenIDs, uint256 key) public onlyOwner {
